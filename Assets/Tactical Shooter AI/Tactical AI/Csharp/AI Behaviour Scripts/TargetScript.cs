...
{
    public class TargetScript : AIBase
    {
        ...
        public override void UpdateEnemyAndAllyLists(TacticalAI.Target[] a, TacticalAI.Target[] e)
        {
            if (myAIBaseScript)
            {
                //allyTransforms = a;
        ...
        protected override void NoticeATarget(TacticalAI.Target newTarget)
        {
