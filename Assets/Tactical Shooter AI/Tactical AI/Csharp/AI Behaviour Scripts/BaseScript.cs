...
namespace TacticalAI
{
    public class BaseScript : MonoBehaviour
    {
        ...
        public Vector3 TimelineDestination;
            ...
            switch(c.commandType)
            {
                ...
                */
                case AICommand.CommandType.AttackTarget:
                    //SetMyTarget(c.target.transform,c.target.transform);
                    //StartEngage();

                    //myTargetScript.
                    break;
                
                case AICommand.CommandType.GoTo:
                    TimelineDestination = c.destination;
                    myIdleBehaviour = IdleBehaviour.MoveToTransform;
                    SetOverrideBehaviour(GetNewBehaviour(AIBehaviour.MoveToTransform),true);
                    break;
        ...
        public void KillAIFromTimeline()
        {
            GetComponent<HealthScript>().KillAI();
        }
