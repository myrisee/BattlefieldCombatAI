...
namespace TacticalAI
{
    public class ControllerScript : MonoBehaviour
    {
        ...
        public int AddTarget(int id, Transform transformToAdd, AIBase script)
        {
            currentID++;
...
namespace TacticalAI
{
    ...
    public class Target
    {
        ...
        public AIBase targetScript;

        public Target(int identity, int id, Transform transformToAdd, AIBase script)
        {
